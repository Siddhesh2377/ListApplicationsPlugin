...
//        }
    ...
    override fun onAiResponse(response: JSONObject): ViewGroup {
        val root = CardView(context).apply {
            ...
            setContentPadding(14.dp, 16.dp, 16.dp, 16.dp)
        }
        ...
        when (response.getString("action")) {
                                            ...
                                            TextView(context).apply {
                                                ...
                                                setOnClickListener {
                                                    launchApp(context, app.packageName) {
                                                        Log.e("Plugin", "❌ Could not launch ${app.name}: $it")
                                                    }
                                                }
                                            }
                                        )
            ...
            "check_if_exists" -> {
                ...
                Log.i(
                    "Plugin",
                    if (exists) "✅ App '$appName' is installed." else "❌ App '$appName' is not installed."
                )
            }
